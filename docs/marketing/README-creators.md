# Dora Coder Content Creator Brief

## Key Features

Dora Coder is an open-source mobile app that lets developers control AI coding agents (Claude Code, Codex, Gemini-CLI) from their phone.
...
- On Dora Coder, I can manage Claude Code from my phone without paying $600/year
- On Dora Coder, I never miss when Claude gets stuck on a permission prompt
- Dora Coder runs on my own computer, not expensive cloud servers
- On Dora Coder, I can check on long-running tasks without returning to my desk
- Dora Coder is open source - I can audit, modify, or self-host everything
- On Dora Coder, I can run multiple agents in parallel and switch between them instantly
- Dora Coder keeps my code on my machines with end-to-end encryption
- On Dora Coder, I can keep coding while commuting, eating, or away from my desk

## Example Hooks

- "I saved $600/year by switching from [competitor] to the open-source Dora Coder"
...
- Clearly say "Dora Coder" in the video or caption
- Mention it's free and open source
- Include link to github.com/PeterFarber/dora
...
- GitHub: https://github.com/PeterFarber/dora
- Website: https://dora.engineering
- iOS App: https://apps.apple.com/us/app/dora-claude-code-client/id6748571505
- Android App: https://play.google.com/store/apps/details?id=com.ex3ndr.dora
- Web App: https://app.dora.engineering/