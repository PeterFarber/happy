...
/**
 * Russian translations for the Dora app
...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'О программе',
        aboutFooter: 'Dora Coder — мобильное приложение для работы с Codex и Claude Code. Использует сквозное шифрование, все данные аккаунта хранятся только на вашем устройстве. Не связано с Anthropic.',
        whatsNew: 'Что нового',
    ...
    newSession: {
        ...
        noMachinesFound: 'Машины не найдены. Сначала запустите сессию Dora на вашем компьютере.',
    ...
    server: {
        ...
        notValidHappyServer: 'Это не валидный сервер Dora',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID сессии Dora скопирован в буфер обмена',
        failedToCopySessionId: 'Не удалось скопировать ID сессии Dora',
        happySessionId: 'ID сессии Dora',
        ...
        happyHome: 'Домашний каталог Dora',
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g dora-coder@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Установите Dora CLI',
            runIt: 'Запустите его',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Терминал запрашивает подключение к вашему аккаунту Dora Coder. Это позволит терминалу безопасно отправлять и получать сообщения.',
    ...
    machine: {
        ...
        offlineHelp: '• Убедитесь, что компьютер online\n• Выполните `dora daemon status` для диагностики\n• Используете последнюю версию CLI? Обновите командой `npm install -g dora-coder@latest`',
