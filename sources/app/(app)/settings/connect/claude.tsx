...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="dora connect claude" />
            {/* <OAuthView
                name="Claude"
                command="dora connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `dora connect ${props.name.toLowerCase()}`;
